...
async function __START() {
    ...
    const sock = sockConnect({
        ...
        browser: ['AKA Multi Device','Safari','1.0.0'],
        auth: state,
        version
    })
...
console.log(color("│ > Name Author : AKA")) 
...
sock.browserDescription = ["AKA-MD", "Mac", "3.0.0"];
...
if (!sock.public && !mek.key.fromMe && !global.owner && chatUpdate.type === 'notify') return
